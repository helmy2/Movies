...
class SearchViewModel @Inject constructor(
    ...
    private fun searchMovie() = viewModelScope.launch {
        movieResults.value = repository.searchMovie(searchText.value)
    }
    ...
    fun searchPerson() = viewModelScope.launch {
        personResults.value = repository.searchPerson(query = searchText.value)
    }
